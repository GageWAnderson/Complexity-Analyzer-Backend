...
import code_complexity_analyzer
import json
...
class TestLambdaFunction(unittest.TestCase):
    def test_lambda_function(self):
        ...
        context = MagicMock()
        result = code_complexity_analyzer.lambda_handler(event, context)
        self.assertEqual(result, {"statusCode": 200, "body": "Called Code Complexity Analyzer"})
